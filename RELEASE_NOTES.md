...
The PKG and ZIP include Valve's official Universal Steamworks runtime. Steam achievements now use the public Steamworks API.

PKG 与 ZIP 均包含 Valve 官方 Universal Steamworks 运行库；Steam 成就现通过公开 Steamworks API 工作。
